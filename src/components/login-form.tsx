      ...
      <form action={action} className="space-y-5">
        {state?.error && (
            <div className="p-3.5 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 rounded-xl flex items-center gap-3 text-sm text-red-600 dark:text-red-400 font-medium animate-in fade-in slide-in-from-top-2">
                <ShieldCheck size={16} className="text-red-500 dark:text-red-400" />
        ...
        <div className="space-y-1.5">
            ...
            <div className="relative flex items-center">
                ...
                <input
                    ...
                    required
                    className="w-full bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-200 text-sm rounded-xl py-3 pl-10 pr-4 outline-none transition-all focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 dark:focus:border-blue-500/50 placeholder:text-slate-400 dark:placeholder:text-slate-600 shadow-sm dark:shadow-none"
                    autoComplete="email"
                />
            </div>
        </div>
        ...
        <div className="space-y-1.5">
            ...
            <div className="relative flex items-center">
                ...
                <input
                    ...
                    placeholder="••••••••••••"
                    required
                    className="w-full bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-200 text-sm rounded-xl py-3 pl-10 pr-10 outline-none transition-all focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 dark:focus:border-blue-500/50 placeholder:text-slate-400 dark:placeholder:text-slate-600 shadow-sm dark:shadow-none"
        ...
        <button
            type="submit"
            disabled={pending}
            className="w-full mt-2 bg-slate-900 dark:bg-gradient-to-r dark:from-blue-600 dark:to-emerald-600 hover:bg-slate-800 dark:hover:from-blue-500 dark:hover:to-emerald-500 text-white font-medium text-sm py-3 px-4 rounded-xl shadow-lg shadow-slate-900/10 dark:shadow-blue-500/20 hover:shadow-xl transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed group"
        >
            {pending ? (
                <>
